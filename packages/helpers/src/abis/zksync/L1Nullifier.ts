...
export const L1Nullifier = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'messageLen', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'enum SharedBridgeKey', name: '', type: 'uint8' }],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'address', name: 'l2Bridge', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: 'bytes32', name: 'txDataHash', type: 'bytes32' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: 'bool', name: 'isFinalized', type: 'bool' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
