...
describe('OPStackNativeWithdrawBridgeProxy: Op1', function () {
  ...
  it('should work for the base sequence using ERC20', async () => {
    ...
    // Approve
    const erc20Contract = await ethers.getContractAt(ABIs.ERC20, op1Assets.udt)
